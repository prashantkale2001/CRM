...
<body> 
    ...
    <div class="container">
     	<div class="row"> 
            <h3 class="text-center">Account Management Dashboard</h3>
            <div class="col-sm-4">
                <a href="#"><div class="well text-center">Employee Payment Entry</div></a>

            </div>

            <div class="col-sm-4">
                <a href="#"><div class="well text-center">Vendor Payment</div></a>
