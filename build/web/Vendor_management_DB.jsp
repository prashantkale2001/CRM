...
<body> 
    ...
    <div class="container">
     	<div class="row"> 
            <h3 class="text-center">Vendor  Management Dashboard</h3>
            <div class="col-sm-3">
                <a href="#"><div class="well text-center">Vendor Enquiry</div></a>

            </div>

            <div class="col-sm-3">
                <a href="#"><div class="well text-center">Vendor FollowUp</div></a>

            </div>

            <div class="col-sm-3">
              <a href="#"><div class="well text-center">Vendor Registration</div></a>
            ...
            <div class="col-sm-3">
              <a href="#"><div class="well text-center">Display Vendor</div></a>
