...
<body> 
    ...
    <div class="container">
     	<div class="row"> 
            <h3 class="text-center">Client Management Dashboard</h3>
            <div class="col-sm-3">
                <a href="#"><div class="well text-center">Add Client</div></a>

            </div>

            <div class="col-sm-3">
                <a href="#"><div class="well text-center">Display Client</div></a>

            </div>

            <div class="col-sm-3">
              <a href="#"><div class="well text-center">Add College</div></a>
            ...
            <div class="col-sm-3">
              <a href="#"><div class="well text-center">Display College</div></a>
