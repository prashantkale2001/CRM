...
public final class StudentRegisterion_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
        ...
        { 
        pstmt.setString(10,"2025-01-01");
        pstmt.setInt(11,0);
        pstmt.setString(12,"Paid");
        pstmt.setString(13,"2025-01-01");
        pstmt.setInt(14, 0);
        pstmt.setString(15,"Paid");
        pstmt.setString(16,"2025-01-01");
        pstmt.setInt(17,0);
        pstmt.setString(18,"Paid");
        pstmt.setString(19, "2025-01-01");
        pstmt.setInt(20, 0);
        pstmt.setString(21,"Paid"); 
        ...
        if (rows > 0) {
            ...
            out.println("<h3>Error in inserting record.</h3>");
        }
